...
interface RunLimitRowProps {
  ...
  draft: RunLimitDraft;
  driverHealth?: RunQuotaDriverHealth;
  disabled: boolean;
  groupLabel: string;
  ...
  return (
    <EuiFlexGroup alignItems="flexStart">
      <EuiFlexItem>
        ...
        {driverHealth?.status === 'degraded' && (
          <EuiText size="xs" color="warning">
            <p>
              {group === 'detection' && driverHealth.staleSpaceCount
                ? i18n.translate(
                    'xpack.significantEventsApp.settings.runLimits.staleDetectionDriverDescription',
                    {
                      ...
                      values: {
                        count: driverHealth.staleSpaceCount,
                      },
                    }
                  )
                : i18n.translate(
